...
ActiveRecord::Schema.define(version: 2021_02_04_133259) do
  ...
  create_table "event_attendings", force: :cascade do |t|
    ...
    t.index ["attending_event_id"], name: "index_event_attendings_on_attending_event_id"
  end
  ...
  add_foreign_key "event_attendings", "events", column: "attending_event_id"
